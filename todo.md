...
- [x] Rename app
- [x] Rip out analytics
- [ ] Save the multi-send address to local storage
- [ ] Save the multi-send-call-only address to local storage
- [ ] Fix this `last-page.png` where it's confused on the address
